...
| UI-08 | Card spacing | Card padding/gap/hover patterns differ too much | StatCard, SectionCard, list cards, and settings shells all use different spacing rules | Normalize card spacing and hover rhythm | P2 | pending | AppSidebar is now aligned; members/roles/StatCard/dashboard still need full spacing-token convergence |
